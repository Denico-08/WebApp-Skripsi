...
class LimeHelper:
    ...
    def __init__(self, x_train_encoded=None, all_features_list=None, class_names_list=None):

        self.explainer = None
        if x_train_encoded is not None and all_features_list is not None and class_names_list is not None:
            self.initialize_explainer(x_train_encoded, all_features_list, class_names_list)
...
# Kita buat instance Helper default
lime_helper_instance = LimeHelper()

def initialize_lime_explainer(_X_train_encoded, all_features_list, class_names_list):
    return lime_helper_instance.initialize_explainer(_X_train_encoded, all_features_list, class_names_list)

def predict_proba_catboost_for_lime(data, model_obj, all_features_list):
    return lime_helper_instance.predict_proba(data, model_obj, all_features_list)
